...
$ouToSearch = "faa.gov/Programs/National/Data_Centers/Servers/WSA_Servers/File_Print"
#===================================================================================================
...
$script:logfile = "C:\Scripts\POWERSHELL\ComputerDetails\logs\ComputerDetailsWSAFile_Print-$(get-date -format MM-dd-yyyy-HH-mm-ss).txt"
$script:separator = @"
$("-" * 25)
"@
...
function Create-Spreadsheet ($colComputerDetails) {
	...
	$Workbook.SaveAs("$ExcelFileDirectory\ComputerDetails-WSAFile_Print.xls")
	$Excel.quit()
