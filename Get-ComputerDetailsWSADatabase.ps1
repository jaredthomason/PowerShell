...
$ouToSearch = "faa.gov/Programs/National/Data_Centers/Servers/WSA_Servers/Database"
#===================================================================================================
...
$script:logfile = "C:\Scripts\POWERSHELL\ComputerDetails\logs\ComputerDetailsWSADatabase-$(get-date -format MM-dd-yyyy-HH-mm-ss).txt"
$script:separator = @"
$("-" * 25)
"@
...
function Create-Spreadsheet ($colComputerDetails) {
	...
	$Workbook.SaveAs("$ExcelFileDirectory\ComputerDetails-WSADatabase.xls")
	$Excel.quit()
