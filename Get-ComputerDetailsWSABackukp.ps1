...
$ouToSearch = "faa.gov/Programs/National/Data_Centers/Servers/WSA_Servers/Backup"
#===================================================================================================
...
$script:logfile = "C:\Scripts\POWERSHELL\ComputerDetails\logs\ComputerDetailsWSABackup-$(get-date -format MM-dd-yyyy-HH-mm-ss).txt"
$script:separator = @"
$("-" * 25)
"@
...
function Create-Spreadsheet ($colComputerDetails) {
	...
	$Workbook.SaveAs("$ExcelFileDirectory\ComputerDetails-WSABackup.xls")
	$Excel.quit()
